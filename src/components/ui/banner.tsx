    ...
    >
      ...
      {id ? (
        <button
          ...
          className="absolute cursor-pointer end-2 md:end-6 top-1/2 -translate-y-1/2 inline-flex items-center justify-center rounded-md h-8 w-8 text-muted-foreground/50 hover:bg-white/10 transition-colors"
        >
