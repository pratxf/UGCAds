...
const SECTIONS: Section[] = [
  ...
  },
  {
    label: "Library",
    items: [
      { label: "UGC Ad Avatars", href: "/admin/avatars", icon: UserCircle },
      { label: "Product Ad Avatars", href: "/admin/product-ad-avatars", icon: UserCircle },
...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#08080A]">
      <aside className="fixed inset-y-0 left-0 z-30 flex w-[248px] flex-col border-r border-white/[0.06] bg-[#0A0A0E]">
        {/* Brand */}
